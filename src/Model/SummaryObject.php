...
/**
 * SummaryObject Class Doc Comment
 *
 * @category Class
 ...
 */
class SummaryObject implements ModelInterface, \JsonSerializable
{
     ...
     * Sets origin
     *
     * @param mixed|null $origin Returns the origin of how the summary was created.  - `api` means that no summary was generated automatically. You can add summary manually using the `PATCH /summaries/{summaryId}/source` endpoint operation. Until this happens, `sourceStatus` returns `missing`. - `auto` means that the API generated the summary automatically.
     *
     * @return self
     */
