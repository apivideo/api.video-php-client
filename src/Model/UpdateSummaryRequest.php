...
/**
 * UpdateSummaryRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateSummaryRequest implements ModelInterface, \JsonSerializable
{
    ...
    public function setTakeaways($takeaways)
    {
        ...
        if (!is_null($takeaways) && (count($takeaways) > 3)) {
            throw new \InvalidArgumentException('invalid value for $takeaways when calling UpdateSummaryRequest., number of items must be less than or equal to 3.');
        }
